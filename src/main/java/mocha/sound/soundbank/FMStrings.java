...
public class FMStrings implements Instrumental {
  ...
  public FMStrings() {
    ...
    env6.putSecondValue(0.05, 0.8);
    env6.putSecondValue(1.2, 0.98);
    env6.putSecondValue(2.5, 0.9);
    eg6 = new EnvelopeGenerator(env6, 1.0, 0, 0.6, 1000);
    
    DoubleMap env5 = new DoubleMap(0);
    env5.putSecondValue(0.05, 0.8);
    env5.putSecondValue(1.2, 0.95);
    eg5 = new EnvelopeGenerator(env5, 1.0, 0, 0.6, 1000);
    
    DoubleMap env4 = new DoubleMap(0);
    env4.putSecondValue(0.05, 0.8);
    env4.putSecondValue(1.7, 0.98);
    env4.putSecondValue(3.2, 0.99);
    eg4 = new EnvelopeGenerator(env4, 0.5, 0, 0.6, 1000);
    
    DoubleMap env3 = new DoubleMap(0);
    env3.putSecondValue(0.08, 1.0);
    eg3 = new EnvelopeGenerator(env3, 0.15, 0, 0.7, 0.5);
    
    DoubleMap env2 = new DoubleMap(0);
    env2.putSecondValue(0.05, 0.9);
    env2.putSecondValue(2.2, 0.98);
    env2.putSecondValue(4.5, 0.93);
    eg2 = new EnvelopeGenerator(env2, 5.0, 0, 0.7, 800);

    DoubleMap env1 = new DoubleMap(0);
    env1.putSecondValue(0.08, 0.99);
    eg1 = new EnvelopeGenerator(env1, 0.15, 0, 0.4, 1);
...
DoubleMap envCutoff = new DoubleMap(1000);
envCutoff.putSecondValue(duration * 0.1, 5000);
DoubleMap quality = new DoubleMap(IIRLowPassFilter.DEFAULT_QUALITY);
LowPassFilterModule lpf = new LowPassFilterModule(played, envCutoff, quality);
Modulator mod = new Modulator(new SineOscillator(), new DoubleMap(3 + velocity), new DoubleMap(1), 0.2);
lpf.setQualityModulator(mod);
